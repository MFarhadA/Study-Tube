...
// Tangkap parameter video dan userID dari URL
if (isset($_GET['video']) && !empty($_GET['video'])) {
    $videoLink = $_GET['video'];  // URL video
} else {
    echo "Video tidak ditemukan.";
    exit;
}
if (isset($_GET['videoID']) && !empty($_GET['videoID'])) {
    $videoID = $_GET['videoID'];  // ID pembuat video
} else {
...
// tombol ikuti
// Tangkap session atau ID pengguna yang sedang login  // Pastikan userID sudah diset dalam session saat login
            ...
            <?php if ($videoLink): ?>
                ...
                <div class="bg-[#48C774] text-white flex items-center justify-between p-3 rounded-lg mb-6 shadow-md w-auto mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
                        ...
                        <button class="hidden items-center bg-white text-[#48C774] font-poppins px-4 py-2 rounded">
