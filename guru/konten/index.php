    ...
    <div id="mainContent" class="main-content bg-white">
        ...
        <div class="fixed top-0 w-full bg-white z-50 shadow-sm">
            <div class="flex items-center space-x-5 p-2">
                ...
                <h1 class="font-poppins font-extrabold text-[#40BA6A] text-xl my-auto">Konten</h1>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <?php if ($resultVideo && $resultVideo->num_rows > 0): ?>
                                            <?php while ($video = $resultVideo->fetch_assoc()): ?>
                                                <tr onclick="location.href='/Study-Tube/guru/edit_video/index.php?videoID=<?= urlencode($video['videoID']) ?>'" class="font-roboto font-normal items-center cursor-pointer hover:bg-gray-100">
                                    ...
                                    <tbody>
                                        <?php if ($resultModul && $resultModul->num_rows > 0): ?>
                                            <?php while ($modul = $resultModul->fetch_assoc()): ?>
                                                ...
                                                ?>
                                                <tr onclick="location.href='/Study-Tube/guru/edit_video/index.php?videoID=<?= urlencode($modul['videoID']) ?>'" class="font-roboto font-normal items-center cursor-pointer hover:bg-gray-100">
                                                    <td class="p-2 w-[125px]">
                                                        <div class="overflow-hidden w-[125px] h-[70px] <?= $bgColor ?> rounded-lg flex items-center justify-center">
