            ...
            <div class="flex flex-col justify-between p-1 h-screen">
                ...
                <div class="flex overflow-y-auto overflow-hidden sidebar-content justify-center mx-1">
                    <ul class="nav flex-wrap space-y-2 mb-5">
                        ...
                        <button onclick="location='/Study-Tube/guru/diskusi/index.php'" class="hidden px-4 py-2 w-[200px] nav-item space-x-3 bg-[#40BA6A] rounded-[10px] transition-transform transform hover:scale-110">
                        ...
                        <button onclick="location='/Study-Tube/guru/koin/index.php'" class="hidden px-4 py-2 w-[200px] nav-item space-x-3 bg-[#40BA6A] rounded-[10px] transition-transform transform hover:scale-110">
