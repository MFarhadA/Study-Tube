    ...
    <div id="mainContent" class="main-content">
        ...
        <div class="container mt-12 p-3">
            ...
            <div class="col-rounded-shadow mx-auto p-2 px-4 h-auto w-auto py-3">
                ...
                <!-- Video -->
                <div class="font-poppins text-lg mb-1 mx-auto">Video</div>
                <form method="POST" action="updateFotoProfil.php" enctype="multipart/form-data">
                    <div class="flex space-x-10 p-2 ml-2 items-center">
                        <!-- Video -->
                        <div class="overflow-hidden w-[250px] h-auto bg-gray-100 rounded-lg items-center">
                            <video controls class="video-element">
                                <source src="/Study-Tube/assets/sample_video.mp4" type="video/mp4">
                ...
                <form method="POST" action="updateFotoProfil.php" enctype="multipart/form-data">
                    <div class="flex space-x-10 p-2 ml-2 items-center">
                        <!-- Gambar Profil -->
                        <div class="overflow-hidden w-[125px] h-auto bg-gray-100 rounded-lg">
